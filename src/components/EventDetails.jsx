    ...
    <div className="timer-grid">
      {['days', 'hours', 'minutes', 'seconds'].map((unit) => (
        <div className={`timer-cell ${unit === 'seconds' ? 'timer-cell--active' : ''}`} key={unit}>
          ...
          <span className="timer-label">{TAMIL_UNITS[unit]}</span>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <section className="events-section section-padding" id="events">
      <div className="container text-center">
        <span className="section-badge">நிகழ்ச்சி & இடம்</span>
        <h2 className="section-title">திருமண நிகழ்வுகள்</h2>
        ...
        <div className="events-stack">
          ...
          <div className="event-card card fade-up">
            ...
            <h3 className="event-name">நிக்காஹ் விழா</h3>
            ...
            <ul className="event-info-list">
              <li>
                ...
                <div>
                  <strong>தேதி</strong>
                  <span>ஞாயிற்றுக்கிழமை, 16 ஆகஸ்ட் 2026</span>
                </div>
              </li>
              <li>
                <span className="info-icon">
                ...
                <div>
                  <strong>நேரம்</strong>
                  <span>மாலை 3:30 மணி (இன்ஷா அல்லாஹ்)</span>
                </div>
              </li>
              <li>
                <span className="info-icon">
          ...
          <div className="event-card card fade-up delay-2">
            ...
            <h3 className="event-name">வலீமா விருந்து</h3>
            ...
            <ul className="event-info-list">
              <li>
                ...
                <div>
                  <strong>தேதி</strong>
                  <span>செவ்வாய்க்கிழமை, 18 ஆகஸ்ட் 2026</span>
                </div>
              </li>
              <li>
                <span className="info-icon">
                ...
                <div>
                  <strong>நேரம்</strong>
                  <span>மதியம் 12:30 மணி முதல்</span>
                </div>
              </li>
              <li>
                <span className="info-icon">
        ...
        <div className="map-card card fade-up delay-3">
          <h3 className="map-title">திருமண நல்விடம்</h3>
          <p className="map-address">மணமகள் இல்லம்</p>
          <p className="map-desc">உங்கள் நல்வருகை எங்கள் வாழ்வில் பேரனுக்கிரகமும் அளவற்ற மகிழ்ச்சியும் தரும். வழியறிய கீழே அழுத்தவும்.</p>
          <a
